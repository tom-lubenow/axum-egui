//! Request context for server functions.
//!
//! Provides access to HTTP request details (headers, cookies, IP) within server functions.
//!
//! # Usage
//!
//! ```ignore
...
//!     let ip = ctx.client_ip().unwrap_or("unknown".into());
//!     Ok(format!("You are {} from {}", user_agent, ip))
//! }
//! ```
